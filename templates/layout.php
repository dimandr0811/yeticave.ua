...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <?php if(!$is_auth == true): ?>
        <a class="main-header__add-lot button" href="sign-up.php">Регистрация</a>
        <a class="main-header__add-lot button" href="login.php">Вход</a>
        ...
        <a class="main-header__add-lot button" href="add.php">Добавить лот</a>
            ...
            <a class="user-menu__logged" style="margin-left: 15px" href="logout.php">Выйти</a>
        <?php endif; ?>
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        <div class="main-footer__copyright">
            <p>© 2020, YetiCave, <br>автор и разработчик: <br>Дмитрий Андрущенко</p>
